...
class FakeController extends Controller implements ViewAwareInterface, SessionAwareInterface, LoggerAwareInterface, DbProviderInterface, EntityManagerAwareInterface
{
    use HasDbTrait;
